...
export enum RiskFlagCode {
  ...
  MEV_SANDWICH_RISK = "MEV_SANDWICH_RISK",
  ...
  AMM_LOW_RESERVE_RISK = "AMM_LOW_RESERVE_RISK",
  AMM_HIGH_SPREAD_MANIPULATION = "AMM_HIGH_SPREAD_MANIPULATION",
  AMM_UNSUPPORTED_PROTOCOL_OR_NO_LIQUIDITY = "AMM_UNSUPPORTED_PROTOCOL_OR_NO_LIQUIDITY",
